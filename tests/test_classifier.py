...
# Гонять реальный обученный классификатор в тестах не хочется (артефакт не в
# git и зависит от того, прогонялся ли ingestion) — обучаем крошечный игрушечный
# пайплайн той же архитектуры прямо в тесте и подставляем его вместо настоящего.
TOY_TEXTS = [
