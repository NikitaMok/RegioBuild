...
_CITATION_RULE = (
    ...
    "из метки [пункт …] целиком (включая префиксы вроде «123-ФЗ/6», «СанПиН/7.1.3»). "
    "Без пункта ответ считается неполным. Если у фрагмента «без номера» — "
    "пиши «пункт не указан» и не выдумывай номер."
)
