...
THANKS_TEXT = (
    "Благодарим за оценку. Рады, что подготовленная справка по нормативным "
    "требованиям оказалась полезной для вашей работы. При последующих вопросах "
    "по региональным и федеральным нормативам градостроительного проектирования "
    "будем рады снова оказать содействие."
)
APOLOGY_TEXT = (
