...
_BUSINESS_TYPE_STEMS: dict[str, tuple[str, ...]] = {
    ...
    "торговый центр": ("торговый центр", "торгов", "трц", "фудкорт"),
    "магазин": ("магазин", "галерея магазинов"),
    "кафе": ("кафе", "бистро", "общественного питания", "общепит"),
    "ресторан": ("ресторан",),
    "столовая": ("столов",),
    "гостиница": ("гостиниц", "гостинич", "гостевой дом", "средство размещения"),
    "отель": ("отел",),
    "медицинский центр": ("медицинск", "медцентр"),
    "медцентр": ("медцентр", "медицинск"),
    "поликлиника": ("поликлиник",),
    "офис": ("офис", "делового центра", "деловой центр", "кабинет", "здание управления"),
    "офисное здание": ("офисн",),
    "административное здание": ("административ",),
